...
node {
    ...
    stage('Initialize Keptn') {
        ...
        keptn.downloadFile('https://raw.githubusercontent.com/syozz/jenkins-tutorial/master/usecases/uc1_qualitygates/keptn/jmeter/load.jmx', 'keptn/jmeter/load.jmx')
        keptn.downloadFile('https://raw.githubusercontent.com/syozz/jenkins-tutorial/master/usecases/uc1_qualitygates/keptn/jmeter/jmeter.conf.yaml', 'keptn/jmeter/jmeter.conf.yaml')
